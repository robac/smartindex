...
class NewIndexer implements \Smartindex\Indexer\iIndexer
{
    private $config;
    private $info;
    private $follow;
    ...
    private function init()
    {
        ...
        $this->info[1][iIndexer::INFO_DIR] = IndexTools::getNamespacePagesDir($this->config->getAttribute('baseDir'), $this->config->getAttribute('namespace'));
